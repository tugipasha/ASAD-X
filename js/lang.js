const translations = {
    tr: {
        ...
        "role_user": "Hiçbiri",
        "role_doctor": "Sağlık çalışanı",
        "role_psychologist": "Psikolog",
        "role_volunteer": "Gönüllü Yardımcı",
        "role_security": "Güvenlik Görevlisi",
        "role_label": "Herhangi bir görevli olarak gidiyorsanız seçiniz",
        "occupancy_label": "konteynerde kaç kişi yaşamaktasınız tıklayınız",
        "special_needs_label": "konteynerda bebek Engelli bulunmakta mıdır belirtiniz",
        ...
        "resource_type_fire": "İtfaiye İstasyonu",
        "resource_type_security": "Güvenlik Noktası",
        "resource_type_paramedic": "Sağlık Görevlisi",
        "resource_type_pharmacy": "Eczane",
        ...
        "label_occupancy": "Konteynerdaki Kişi Sayısı",
        "occupancy_placeholder": "Kişi sayısı",
        "shelter_placeholder": "Barınma Detayı (Örn: Konteyner A-12, Çadır 5)",
        "ai_advisor_title": "Yapay Zeka Danışmanı",
        "ai_advisor_desc": "Psikolojik durum ve beslenme takibi için danışmanınız.",
        "open_ai_chat": "Danışmana Bağlan",
        "breathing_exercise_title": "Nefes Egzersizi",
        "breathing_exercise_desc": "Sakinleşmek ve stres yönetimi için egzersiz yapın.",
        "start_breathing": "Egzersizi Başlat",
        "ai_chat_header": "Yapay Zeka Psikolojik Danışmanı",
        "ai_initial_msg": "Merhaba! Ben psikolojik danışmanınız. Bugün nasıl hissediyorsunuz? Size beslenme veya ruh halinizle ilgili nasıl yardımcı olabilirim?",
        "ai_input_placeholder": "Mesajınızı yazın...",
        "ai_error_msg": "Üzgünüm, şu an yanıt veremiyorum. Lütfen tekrar deneyin.",
        "breathing_title": "Nefes Egzersizi",
        "breath_in": "Nefes Al",
        "breath_hold": "Tut",
        "breath_out": "Nefes Ver",
        "breathing_instruction": "Mavi daire büyürken nefes alın, küçülürken nefes verin.",
        "stop_exercise": "Egzersizi Bitir",
    ...
    en: {
        ...
        "role_user": "None",
        "role_doctor": "Health worker",
        "role_psychologist": "Psychologist",
        "role_volunteer": "Volunteer Helper",
        "role_security": "Security Guard",
        "role_label": "Select if you are registering as a staff member",
        "occupancy_label": "how many people live in the container click to enter",
        "special_needs_label": "specify if there are babies or disabled people in the container",
        ...
        "resource_type_fire": "Fire Station",
        "resource_type_security": "Security Point",
        "resource_type_paramedic": "Paramedic",
        "resource_type_pharmacy": "Pharmacy",
        ...
        "label_occupancy": "Number of People in Container",
        "occupancy_placeholder": "Number of people",
        "shelter_placeholder": "Shelter Detail (e.g. Container A-12, Tent 5)",
        "ai_advisor_title": "AI Advisor",
        "ai_advisor_desc": "Your advisor for psychological state and nutrition tracking.",
        "open_ai_chat": "Connect to Advisor",
        "breathing_exercise_title": "Breathing Exercise",
        "breathing_exercise_desc": "Exercise to calm down and manage stress.",
        "start_breathing": "Start Exercise",
        "ai_chat_header": "AI Psychological Advisor",
        "ai_initial_msg": "Hello! I am your psychological advisor. How are you feeling today? How can I help you with nutrition or your mood?",
        "ai_input_placeholder": "Type your message...",
        "ai_error_msg": "Sorry, I cannot respond right now. Please try again.",
        "breathing_title": "Breathing Exercise",
        "breath_in": "Breathe In",
        "breath_hold": "Hold",
        "breath_out": "Breathe Out",
        "breathing_instruction": "Breathe in while the blue circle grows, breathe out while it shrinks.",
